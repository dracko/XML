   ...
   <oracle-xsl-mapper:schema>
      ...
      <oracle-xsl-mapper:mapTargets>
         <oracle-xsl-mapper:target type="XSD">
            <oracle-xsl-mapper:schema location="../xsd/VentaSchema.xsd"/>
            <oracle-xsl-mapper:rootElement name="resumen" namespace="http://www.example.org"/>
         </oracle-xsl-mapper:target>
      </oracle-xsl-mapper:mapTargets>
      <!--GENERATED BY ORACLE XSL MAPPER 12.2.1.1.0(XSLT Build 160608.1900.0023) AT [THU JAN 05 10:33:28 CST 2023].-->
   </oracle-xsl-mapper:schema>
   <!--User Editing allowed BELOW this line - DO NOT DELETE THIS LINE-->
   <xsl:template match="/">
      <ns0:resumen>
         <ns0:fecha>
            <xsl:value-of select="concat (/ns0:productos/ns0:fechaIngreso/ns0:dia, &quot;-&quot;, /ns0:productos/ns0:fechaIngreso/ns0:mes, &quot;-&quot;, /ns0:productos/ns0:fechaIngreso/ns0:anio )"/>
         </ns0:fecha>
         <ns0:cantidadDeProductos>
            <xsl:value-of select="count (/ns0:productos/ns0:listaDeProductos/ns0:producto )"/>
         </ns0:cantidadDeProductos>
         <ns0:total>
            <xsl:value-of select="sum (/ns0:productos/ns0:listaDeProductos/ns0:producto/ns0:precio )"/>
         </ns0:total>
      </ns0:resumen>
   </xsl:template>
</xsl:stylesheet>
